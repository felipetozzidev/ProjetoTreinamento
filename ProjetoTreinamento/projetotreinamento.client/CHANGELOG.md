...
- Crie um projeto angular com ng: `ng new projetotreinamento.client --defaults --skip-install --skip-git --no-standalone `.
...
- Criar o arquivo de projeto (`projetotreinamento.client.esproj`).
